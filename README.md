...
4. https://github.com/fastai/numerical-linear-algebra/blob/master/README.md (ML workflow moderno)
5. https://www.coursera.org/specializations/mathematics-machine-learning (Curso Coursera)
6. https://web.stanford.edu/~boyd/vmls/ (Libro "Introducción al Álgebra Lineal Aplicada")
7. https://ocw.mit.edu/courses/mathematics/18-06-linear-algebra-spring-2010/index.htm (Curso del MIT muy comprensible)
8. http://cs229.stanford.edu/section/cs229-linalg.pdf (Review CS229 sobre Álgebra Lineal de la Universidad de Standford)
